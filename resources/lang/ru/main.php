...
//    'access' => 'Доступ',
    ...
    'ua_replace' => 'Заменить',
    'ua_calcfirst' => 'Расчет Первый()',
    'ua_calclast' => 'Расчет Последний()',
    'is_savesets_enabled'=>'Включено для присваиваний (отключать при "Только связь" - для вывода полей из вычисляемой Основы)',
