            ...
            <div class="row text-center">
                <div class="col-5 text-right">
                    <button type="submit" class="btn btn-dreamer"
                            @if (!$update)
                            title="{{trans('main.add')}}"><i class="fa fa-save .hidden-xs-down"></i>&nbsp;{{trans('main.add')}}
                        @else
                            title="{{trans('main.save')}}"><i class="fa fa-save .hidden-xs-down"></i>&nbsp;{{trans('main.save')}}
                        @endif
                    </button>
                </div>
                <div class="col-2">
                ...
                <div class="col-5 text-left">
                    ...
                    ><i class="fa fa-arrow-left .hidden-xs-down"></i>&nbsp;{{trans('main.cancel')}}
                    </button>
                </div>
            </div>
        </div>
