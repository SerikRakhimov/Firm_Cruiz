...
{{--    Использовать именно так @if($is_align_middle)align_middle@endif"--}}
    class="text-center@if($is_align_middle)align_middle@endif"
@else
    {{--    Использовать именно так @if($is_align_middle)align_middle@endif"--}}
    class="text-left@if($is_align_middle)align_middle@endif"
@endif
