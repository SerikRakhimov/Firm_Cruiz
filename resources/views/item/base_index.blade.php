...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @if($base_right['is_list_base_create'] == true)
            <div class="col-12 text-right">
                <button type="button" class="btn btn-dreamer" title="{{trans('main.add')}}"
                     onclick="document.location='{{route('item.ext_create', ['base'=>$base, 'project'=>$project, 'role'=>$role])}}'"><i class="fas fa-plus d-inline"></i>&nbsp;{{trans('main.add')}}
                </button>
            </div>
        @endif
        ...
        @if ($base->is_calcname_lst == true)
            <div class="col-12 text-right">
                <a href="{{route('item.calculate_name', ['base'=>$base, 'project'=>$project])}}" title="{{trans('main.calculate_name')}}">
        ...
        @if ($base->is_recalc_code == true)
            <div class="col-12 text-right">
                <a href="{{route('item.recalculation_codes',['base'=>$base, 'project'=>$project])}}" title="{{trans('main.recalculation_codes')}}">
...
{{--                </td>--}}
                <td class="text-center">
                    <a href="{{route('item.ext_show', ['item'=>$item, 'role'=>$role])}}" title="{{trans('main.view')}}">
                ...
                @if($base_right['is_list_base_update'] == true)
                    <td class="text-center">
                        <a href="{{route('item.ext_edit', ['item'=>$item, 'role'=>$role])}}"
...
{{--                </td>--}}
                @if(ItemController::is_delete($item, $role) == true)
                    <td class="text-center">
                        <a href="{{route('item.ext_delete_question', ['item'=>$item, 'role'=>$role])}}" title="{{trans('main.delete')}}">
